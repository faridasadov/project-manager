...
const translations = {
  az: {
    ...
    lcClosed: "Bağlanmış",
    stageOrder: "Sifariş",
    stageEvaluation: "Qiymətləndirmə",
    stageApproval: "Təsdiq",
    stageProcurement: "Təchizat",
    stageExecution: "İcra",
    stageDelivery: "Təhvil-təslim",
    stageReporting: "Hesabat",
    stageProcessTitle: "Mərhələ prosesi",
    stageCurrent: "Cari mərhələ",
    stageHistoryTitle: "Mərhələ tarixçəsi",
    stageBack: "Geri",
    stageForward: "İrəli",
    stageNotePrompt: "Mərhələ qeydi (istəyə bağlı):",
    stageNoPermission: "Mərhələni yalnız layihə meneceri və ya admin dəyişə bilər.",
    stageChanged: "Mərhələ yeniləndi",
    ...
    personalSettings: "Parametrlər",
    personalSettingsTitle: "Şəxsi parametrlər",
    ...
    reportMandatoryHint: "Rəhbərlik rolu üçün gündəlik hesabat məcburidir — söndürmək olmaz. Yalnız saatı dəyişə bilərsiniz.",
    linkedToProject: "Layihəyə bağlı",
    otherCompanyResources: "Şirkətin digər resursları",
    clearFilters: "Filtrləri təmizlə",
    searchLabel: "Axtarış",
    noResults: "Nəticə tapılmadı",
    ownerHint: "Nəzarət edən — icraçının rəhbəri avtomat gəlir",
    projectResourceHint: "İşi görən icraçı — seçdikdə məsul şəxsə onun rəhbəri düşür",
    ...
    teams: "Komandalar",
    emailLabel: "Email",
    resetPasswordKicker: "Şifrə yeniləmə",
    sendResetLink: "Bərpa linki göndər",
    teamsViewTitle: "Komanda idarəetməsi",
    newTeamBtn: "+ Komanda",
    newUserBtn: "+ İstifadəçi",
    freeUsers: "Sərbəst istifadəçilər",
    freeUsersHint: "Kartlara sürüşdürərək komandaya əlavə et",
    ...
    statusPlan: "Plan",
    statusActive: "Davam edir",
    statusDone: "Bitib",
    taskWord: "Task",
    responsible: "Məsul",
    statusWord: "Status",
    priorityWord: "Prioritet",
    reportTaskDistribution: "Layihələr üzrə task paylanması",
    reportTaskDistributionSub: "Plan, davam edən və bitmiş",
    reportPlanVsActual: "Plan vs Fakt saat",
    reportPlanVsActualSub: "Layihələr üzrə",
    reportProjectSummary: "Layihə xülasəsi",
    reportProjectSummarySub: "Cari vəziyyət və məsul şəxslər",
    hoursSummary: "Saat plan/fakt",
    workload: "Resurs effektivliyi",
    wlSpend: "Sərf",
    wlDone: "Tamamlanma",
    wlAhead: "Öndə",
    wlOnTrack: "Qrafikdə",
    ...
    deletedResource: "Silinmiş istifadəçi",
    edit: "Redaktə",
    next: "İrəli",
    reopen: "Davam etdir",
    doneRequest: "Bitdi",
    ...
    confirmPassword: "Yeni parol (təkrar)",
    passwordSettings: "Parol",
    passwordSettingsHint: "Öz parolunu dəyiş. Ən azı 6 simvol.",
    changePasswordBtn: "Parolu dəyiş",
    passwordTooShort: "Parol ən azı 6 simvol olmalıdır",
    passwordMismatch: "Parollar uyğun gəlmir",
    passwordReset: "Parol bərpası",
    setNewPassword: "Yeni parol təyin et",
    setNewPasswordHint: "Hesabınız üçün yeni parol daxil edin. Ən azı 6 simvol.",
    superAdminRole: "Super admin",
    adminRole: "Şirkət admini",
    managerRole: "Manager",
    rehberlikRole: "Rəhbərlik",
    userRole: "User",
  ...
  ru: {
    ...
    lcClosed: "Закрыто",
    stageOrder: "Заказ",
    stageEvaluation: "Оценка",
    stageApproval: "Утверждение",
    stageProcurement: "Снабжение",
    stageExecution: "Исполнение",
    stageDelivery: "Сдача-приёмка",
    stageReporting: "Отчётность",
    stageProcessTitle: "Этапы процесса",
    stageCurrent: "Текущий этап",
    stageHistoryTitle: "История этапов",
    stageBack: "Назад",
    stageForward: "Вперёд",
    stageNotePrompt: "Примечание к этапу (необязательно):",
    stageNoPermission: "Этап может менять только менеджер проекта или админ.",
    stageChanged: "Этап обновлён",
    ...
    personalSettingsTitle: "Личные настройки",
    reportEmail: "Почта (для отчётов)",
    reportLanguage: "Язык отчётов",
    ...
    reportMandatoryHint: "Для роли «Руководство» ежедневный отчёт обязателен — отключить нельзя. Можно изменить только время.",
    linkedToProject: "Привязаны к проекту",
    otherCompanyResources: "Другие ресурсы компании",
    clearFilters: "Сбросить фильтры",
    searchLabel: "Поиск",
    noResults: "Ничего не найдено",
    ownerHint: "Контролирующий — руководитель исполнителя подставляется автоматически",
    projectResourceHint: "Исполнитель — при выборе в «Ответственный» подставляется его руководитель",
    ...
    teams: "Команды",
    emailLabel: "Email",
    resetPasswordKicker: "Сброс пароля",
    sendResetLink: "Отправить ссылку",
    teamsViewTitle: "Управление командами",
    newTeamBtn: "+ Команда",
    newUserBtn: "+ Пользователь",
    freeUsers: "Свободные пользователи",
    freeUsersHint: "Перетащите на карточку, чтобы добавить в команду",
    ...
    reportTaskDistribution: "Распределение задач по проектам",
    reportTaskDistributionSub: "План, в работе и готово",
    reportPlanVsActual: "План vs Факт часов",
    reportPlanVsActualSub: "По проектам",
    reportProjectSummary: "Сводка по проектам",
    reportProjectSummarySub: "Текущий статус и ответственные",
    hoursSummary: "Часы план/факт",
    workload: "Эффективность ресурсов",
    wlSpend: "Затрата",
    wlDone: "Выполнение",
    wlAhead: "Опережает",
    wlOnTrack: "По плану",
    ...
    deletedResource: "Удалённый пользователь",
    edit: "Редактировать",
    next: "Далее",
  ...
  en: {
    ...
    stageProcessTitle: "Stage process",
    stageCurrent: "Current stage",
    stageHistoryTitle: "Stage history",
    stageBack: "Back",
    stageForward: "Next",
    stageNotePrompt: "Stage note (optional):",
    stageNoPermission: "Only the project manager or an admin can change the stage.",
    ...
    reportMandatoryHint: "Daily reports are mandatory for the Leadership role — they cannot be turned off. Only the time can be changed.",
    linkedToProject: "Linked to project",
    otherCompanyResources: "Other company resources",
    clearFilters: "Clear filters",
    searchLabel: "Search",
    noResults: "No results found",
    ownerHint: "Supervisor — the assignee's manager is filled in automatically",
    projectResourceHint: "The assignee doing the work — selecting one sets their manager as supervisor",
    ...
    teams: "Teams",
    emailLabel: "Email",
    resetPasswordKicker: "Password reset",
    sendResetLink: "Send reset link",
    teamsViewTitle: "Team management",
    newTeamBtn: "+ Team",
    newUserBtn: "+ User",
    freeUsers: "Unassigned users",
    freeUsersHint: "Drag onto a card to add to a team",
    ...
    reportTaskDistribution: "Tasks by project",
    reportTaskDistributionSub: "Planned, in progress and done",
    reportPlanVsActual: "Planned vs Actual hours",
    reportPlanVsActualSub: "By project",
    reportProjectSummary: "Project summary",
    reportProjectSummarySub: "Current status and owners",
    hoursSummary: "Hours plan/actual",
    workload: "Resource efficiency",
    wlSpend: "Spent",
    wlDone: "Completion",
    wlAhead: "Ahead",
    wlOnTrack: "On track",
    ...
    passwordSettingsHint: "Change your own password. At least 6 characters.",
    changePasswordBtn: "Change password",
    passwordTooShort: "Password must be at least 6 characters",
    passwordMismatch: "Passwords do not match",
    passwordReset: "Password recovery",
    setNewPassword: "Set new password",
    setNewPasswordHint: "Enter a new password for your account. At least 6 characters.",
    superAdminRole: "Super admin",
    adminRole: "Company admin",
    managerRole: "Manager",
    rehberlikRole: "Leadership",
    userRole: "User",
    contributorRole: "Contributor",
    viewerRole: "Viewer",
    sponsorRole: "Sponsor",
