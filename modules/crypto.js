// Project Manager — MD5 hashing (self-contained, pure).
//
// Classic <script> loaded before script.js. Legacy hash kept for existing
// stored data compatibility; do not use for new security-sensitive hashing.
